...
class ApiQuery {
  ...
  Future<Response?> getQuery(String url,
  ...
  Future<Response?> patchQuery(String url, Map<String, String> headers,
      dynamic data, String apiName) async {
    Response response;
    try {
      print(headers);
      ...
      print(Constants.baseUrl + url);
      response =
      await dio.patch(Constants.baseUrl + url, data: data, options: options);
      print(response);
      print(response.statusCode);
      return response;
    } on DioError catch (exception) {
  ...
  Future<Response?> putVideoQuery(String signedUrl, Map<String, String> headers,
      dynamic data, String apiName) async {
    Response response;
    try {
      print(headers);
      ...
      print(signedUrl);
      response =
      await dio.put(signedUrl, data: data, options: options);
      print(response);
      return response;
    } on DioError catch (exception) {
      if (exception.toString().contains('SocketException')) {
  ...
  Future<Response?> deleteQuery(String url, Map<String, String> headers,
    ...
    try {
      ...
      if (isBaseUrlToBeAdded) {
        response = await dio.delete(Constants.baseUrl + url,
